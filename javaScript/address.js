...
// ⭐ START: NEW FUNCTION TO POPULATE FORM ⭐
...
// ⭐ START: NEW FUNCTION TO FETCH ADDRESS FROM COORDS ⭐
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // ⭐ START: GEOLOCATION BUTTON LOGIC ⭐
    const useLocationBtn = document.getElementById('use-location-btn');
    if (useLocationBtn) {
    ...
    addressForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const cameFromCart = document.referrer.includes('/cart.html');
            setTimeout(() => {
                if (cameFromCart) {
